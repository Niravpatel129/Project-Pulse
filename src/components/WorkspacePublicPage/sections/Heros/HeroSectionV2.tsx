...
export default function HeroSectionV2({ id }: { id: string }) {
  ...
  return (
    ...
    >
      {/* Background Image */}
      <Image
        src='https://firebasestorage.googleapis.com/v0/b/pulse-20181.firebasestorage.app/o/manual%2FIMG_7081%201.png?alt=media&token=01fcaa72-556d-4311-8469-91a3b49b07e3'
        alt='Hero Background'
        fill
        priority
        onLoad={() => {
