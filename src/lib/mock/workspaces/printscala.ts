...
export const printscala: WorkspaceCMSData = {
  ...
  settings: {
    ...
    favicons: {
      icon16: 'https://i.ibb.co/1tfTHZYj/android-chrome-512x512.png',
      icon32: 'https://i.ibb.co/1tfTHZYj/android-chrome-512x512.png',
      appleTouchIcon: 'https://i.ibb.co/1tfTHZYj/android-chrome-512x512.png',
      safariPinnedTab: 'https://i.ibb.co/1tfTHZYj/android-chrome-512x512.png',
      msapplicationTileImage: 'https://i.ibb.co/1tfTHZYj/android-chrome-512x512.png',
    },
    favicon: {
      id: 'printscala-favicon',
      url: 'https://i.ibb.co/1tfTHZYj/android-chrome-512x512.png',
