...
export const printscala: WorkspaceCMSData = {
  ...
  settings: {
    ...
    favicons: {
      icon16: 'https://i.ibb.co/b5KJvRmb/Adobe-Express-file-1.png',
      icon32: 'https://i.ibb.co/b5KJvRmb/Adobe-Express-file-1.png',
      appleTouchIcon: 'https://i.ibb.co/b5KJvRmb/Adobe-Express-file-1.png',
      safariPinnedTab: 'https://i.ibb.co/b5KJvRmb/Adobe-Express-file-1.png',
      msapplicationTileImage: 'https://i.ibb.co/b5KJvRmb/Adobe-Express-file-1.png',
    },
    favicon: {
      id: 'printscala-favicon',
      url: 'https://i.ibb.co/b5KJvRmb/Adobe-Express-file-1.png',
