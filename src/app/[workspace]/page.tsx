          ...
          <div className='text-center'>
            ...
            <div className='mt-12 grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3'>
              ...
              <motion.div
                ...
                onClick={() => {
                  return navigateToSection('invoices');
                }}
                className='bg-white rounded-lg shadow-md p-6 cursor-pointer hover:shadow-lg transition-shadow border border-gray-200'
              >
                <div className='h-12 w-12 mx-auto bg-purple-100 text-purple-600 rounded-lg flex items-center justify-center mb-4'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    className='h-6 w-6'
                    fill='none'
                ...
                <p className='text-gray-600'>Create, send, and track invoices and payments</p>
              </motion.div>
            </div>
