              ...
              <tbody className='divide-y divide-slate-100 dark:divide-[#232428]'>
                {filteredInvoices.map((invoice: any) => {
                  return (
                    <tr
                      key={invoice._id}
                      className={`divide-x divide-slate-100 dark:divide-[#232428] cursor-pointer transition-colors duration-150 hover:bg-slate-50/50 dark:hover:bg-[#232428] ${
                    ...
                    >
                      ...
                      <td className='px-6 py-4 text-slate-600 dark:text-slate-300 flex items-center'>
