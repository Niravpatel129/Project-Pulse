...
export default function DashboardLayout({
  ...
  // Create a layout wrapper that maintains consistent dimensions
  return (
    <div className='flex min-h-screen flex-col'>
      {/* Top Navigation Bar - Always render but conditionally show content */}
      ...
      {/* Main Content - Always maintain the same structure */}
      <main className='flex-1 p-4 sm:p-6 md:p-8'>
        {/* For login page or loading state, wrap children in a container that takes full height */}
        {isLoginPage || isLoading || loading ? (
          <div className='min-h-[calc(100vh-4rem)] flex'>{children}</div>
        ) : (
          children
        )}
      </main>
